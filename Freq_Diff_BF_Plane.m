function [B,b] = Freq_Diff_BF_Plane(geometry, SIGNALS, rec_weights)
...
ThetaRange = geometry.xRange; % Test DOAs in degrees (column vector)
...
for fi = lowFID:highFID-df_i
    ...
    for n = 1:numRec
        ...
        A = exp(1i*2*pi*df*recArray(n)*sind(ThetaRange));
